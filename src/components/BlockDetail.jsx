      ...
      <section className="block-detail-section">
        <div className="audience-intro-layout">
          <div className="audience-intro-text">
            ...
            <p>
              На данном этапе продукт существует только как гипотеза (проблема, результат, формат, цена, аудитория), без создания финальной версии. Уроки, платформы, лендинги и воронки создаются только после подтверждения гипотезы.
            </p>
          </div>
